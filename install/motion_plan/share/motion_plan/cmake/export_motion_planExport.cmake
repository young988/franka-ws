...
foreach(_expectedTarget motion_plan::motion_plan)
...
# Create imported target motion_plan::motion_plan
add_library(motion_plan::motion_plan SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/export_motion_planExport-*.cmake")
